@echo off
REM ====================================================================
REM  Doble clic para comprobar el equipo. Windows.
REM
...
REM
REM  Este fichero solo busca un Python y llama a comprobar_equipo.py,
REM  que es donde estan las seis comprobaciones. Cero llamadas a la API.
REM
